...
function travel(event){
   ...
   if(searchVal == "Biology"){
      ...
      window.location.href = 'https://foderjrpi.eastus.cloudapp.azure.com/team2/CEH/pages/coursePages/BIOL-1010/introBiol.html';
   }else if(searchVal == "Intro to Computer Science"){
      //rel: pages/coursePages/CSCI-1100/computerSci.html
      window.location.href = 'https://foderjrpi.eastus.cloudapp.azure.com/team2/CEH/pages/coursePages/CSCI-1100/computerSci.html';
   }else if(searchVal == "Data Structures"){
      //rel: pages/coursePages/CSCI-1200/datastructures.html 
      window.location.href = 'https://foderjrpi.eastus.cloudapp.azure.com/team2/CEH/pages/coursePages/CSCI-1200/datastructures.html';
   }else if(searchVal == "Physics 1"){
      //rel: pages/coursePages/PHYS-1100/physics1.html
      window.location.href = 'https://foderjrpi.eastus.cloudapp.azure.com/team2/CEH/pages/coursePages/PHYS-1100/physics1.html';
   }else{
      $('#searchBar').val("");
